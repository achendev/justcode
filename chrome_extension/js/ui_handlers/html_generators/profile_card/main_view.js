export function getMainViewHTML(profile) {
    ...
    <div class="profile-main-view">
        <div class="profile-header">
            ...
            <button class="btn btn-outline-secondary btn-sm archive-profile" data-id="${profile.id}" title="Archive Profile (Hold Shift to Delete)"><i class="bi bi-archive"></i></button>
        ...
        <div class="d-flex align-items-end gap-2 mb-2">
            <div class="flex-grow-1">
                <div class="input-group input-group-sm">
                    ...
                    <button class="btn btn-outline-secondary get-exclusion-prompt" type="button" data-id="${profile.id}" title="Get AI-suggestion for exclude/include patterns"><i class="bi bi-funnel"></i></button>
                </div>
            </div>
